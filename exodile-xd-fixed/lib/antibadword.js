...
async function handleBadwordDetection(sock, chatId, message, userMessage, senderId) {
    ...
    // Single unified config read — avoids double-check mismatch between file and store
    const antiBadwordConfig = await store.getSetting(chatId, 'antibadword')
        || await loadAntibadwordConfig(chatId);
