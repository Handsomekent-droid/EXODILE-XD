...
module.exports = {
  ...
  async handler(sock, message, args, context = {}) {
    ...
    try {
      ...
      if (!textToTranslate) {
        return await sock.sendMessage(chatId, {
          text: 'No text found to translate. ᴘʟᴇᴀsᴇ provide text or reply to a message.',
          quoted: message
        });
      }
      ...
      if (!translatedText) {
        throw new Error('All translation APIs ꜰᴀɪʟᴇᴅ');
      }
      ...
      console.error(error);
      await sock.sendMessage(chatId, {
        text: '❌ ꜰᴀɪʟᴇᴅ to translate text. ᴘʟᴇᴀsᴇ try again later.\n\nUsage:\n1. Reply to a message with: .translate <lang> or .trt <lang>\n2. Or type: .translate <text> <lang> or .trt <text> <lang>',
        quoted: message
      });
    }
  }
