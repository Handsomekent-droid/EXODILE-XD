...
module.exports = {
  ...
  async handler(sock, message, args, context = {}) {
    ...
    try {
      ...
      if (!data?.status) {
        return await sock.sendMessage(chatId, { text: '❌ ꜰᴀɪʟᴇᴅ to convert the units. Check if the units are correct.' }, { quoted: message });
      }
      ...
      if (error.code === 'ECONNABORTED') {
        ...
        await sock.sendMessage(chatId, { text: '❌ ꜰᴀɪʟᴇᴅ to convert units.' }, { quoted: message });
      }
    }
  }
};
