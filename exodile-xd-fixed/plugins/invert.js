...
module.exports = {
  ...
  async handler(sock, message, args, context = {}) {
    ...
    try {
      ...
      if (!res?.data) throw new Error('Negative conversion ꜰᴀɪʟᴇᴅ');
      ...
      await sock.sendMessage(
        chatId,
        { text: '❌ ꜰᴀɪʟᴇᴅ to convert image to sepia. Make sure the image is clear and try again.' },
        { quoted: message }
      );
    }
  }
