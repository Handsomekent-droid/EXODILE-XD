...
module.exports = {
  command: 'imagine',
  aliases: ['imagine2', 'draw', 'genimage'],
  category: 'ai',
  ...
  async handler(sock, message, args, context = {}) {
    ...
    if (!imagePrompt) {
      await sock.sendMessage(chatId, {
        text: 'ᴘʟᴇᴀsᴇ provide a prompt for the image generation.\nExample: .imagine a beautiful sunset over mountains'
      }, { quoted: message });
      return;
    }
    await sock.sendMessage(chatId, {
      text: '🎨 Generating your image... ᴘʟᴇᴀsᴇ wait.'
    }, { quoted: message });
    ...
    try {
      ...
      console.error(error);
      await sock.sendMessage(chatId, {
        text: '❌ ꜰᴀɪʟᴇᴅ to generate image. ᴘʟᴇᴀsᴇ try again later.'
      }, { quoted: message });
    }
  }
};
