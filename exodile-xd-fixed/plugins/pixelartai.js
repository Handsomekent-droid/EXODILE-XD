...
module.exports = {
  command: 'pixelartai',
  aliases: ['pixelart', 'aipixel'],
  category: 'images',
  description: 'ɢᴇɴᴇʀᴀᴛᴇ ᴘɪxᴇʟ ᴀʀᴛ ᴀɪ ɪᴍᴀɢᴇ',
  usage: '.pixelartai <ᴘʀᴏᴍᴘᴛ>',
  ...
  async handler(sock, message, args, context = {}) {
    ...
    await sock.sendMessage(chatId, { text: `𖤐 ɢᴇɴᴇʀᴀᴛɪɴɢ *ᴘɪxᴇʟ ᴀʀᴛ* ɪᴍᴀɢᴇ...`, ...ci }, { quoted: message });
    try {
      const imgUrl = await fetchImageUrl(prompt, 'pixelart');
      ...
      if (imgUrl.startsWith('http')) {
        ...
        await sock.sendMessage(chatId, { image: Buffer.from(data), caption: H + `𖤐 *ᴘɪxᴇʟ ᴀʀᴛ*\n𖤐 ᴘʀᴏᴍᴘᴛ: ${prompt}`, ...ci }, { quoted: message });
      } else {
        await sock.sendMessage(chatId, { image: { url: imgUrl }, caption: H + `𖤐 *ᴘɪxᴇʟ ᴀʀᴛ*\n𖤐 ᴘʀᴏᴍᴘᴛ: ${prompt}`, ...ci }, { quoted: message });
      }
    } catch (e) {
