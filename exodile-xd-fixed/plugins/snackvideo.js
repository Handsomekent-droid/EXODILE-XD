...
module.exports = {
  ...
  async handler(sock, message, args, context = {}) {
    ...
    if (!url) {
      return await sock.sendMessage(chatId, { text: 'ᴘʟᴇᴀsᴇ provide a SnackVideo URL.\nExample: .snack https://sck.io/p/...' }, { quoted: message });
    }
    ...
    try {
      ...
      if (error.code === 'ECONNABORTED') {
        ...
        await sock.sendMessage(chatId, { text: '❌ ꜰᴀɪʟᴇᴅ to fetch SnackVideo media.' }, { quoted: message });
      }
    }
  }
};
