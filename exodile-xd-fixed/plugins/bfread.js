module.exports = {
  ...
  async handler(sock, message, args, context = {}) {
    ...
    try {
      ...
      if (!code) {
        return await sock.sendMessage(chatId, { text: '*ᴘʟᴇᴀsᴇ reply to a Brainfuck code or provide it after the ᴄᴏᴍᴍᴀɴᴅ.*' }, { quoted: message });
      }
      ...
      await sock.sendMessage(chatId, { text: '❌ ᴇʀʀᴏʀ reading quoted message.' });
    }
  }
};
