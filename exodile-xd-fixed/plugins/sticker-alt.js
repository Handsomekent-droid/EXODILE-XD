...
module.exports = {
    ...
    async handler(sock, message, args, context = {}) {
        ...
        try {
            ...
            if (!quotedMsg) {
                await sock.sendMessage(chatId, { text: '⚠️ ᴘʟᴇᴀsᴇ reply to an image or video!' }, { quoted: message });
                return;
            }
            ...
            console.error(error);
            await sock.sendMessage(chatId, { text: '❌ ꜰᴀɪʟᴇᴅ to create sticker!' }, { quoted: message });
        }
    }
};
