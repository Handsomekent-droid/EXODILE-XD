...
module.exports = {
  ...
  async handler(sock, message, args, context = {}) {
    ...
    if (!query) {
      return await sock.sendMessage(chatId, { text: '*ᴘʟᴇᴀsᴇ provide a word to search for.*\nExample: .define hello' }, { quoted: message });
    }
    ...
    try {
      ...
      console.error(error);
      await sock.sendMessage(chatId, { text: '❌ ꜰᴀɪʟᴇᴅ to fetch definition.', }, { quoted: message });
    }}
};
