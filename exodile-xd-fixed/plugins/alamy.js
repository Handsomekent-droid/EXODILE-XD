...
module.exports = {
  ...
  async handler(sock, message, args, context = {}) {
    ...
    if (!url) {
      return await sock.sendMessage(chatId, { text: '❌ ᴘʟᴇᴀsᴇ provide an Alamy URL.\nExample: .alamy https://www.alamy.com/video/beautiful-lake...' }, { quoted: message });
    }
    ...
    try {
      ...
      if (!data?.status || !data.result?.length) {
        return await sock.sendMessage(chatId, { text: '❌ ꜰᴀɪʟᴇᴅ to fetch media from the provided Alamy URL.' }, { quoted: message });
      }
      ...
      if (error.code === 'ECONNABORTED') {
        ...
        await sock.sendMessage(chatId, { text: '❌ ꜰᴀɪʟᴇᴅ to download media from Alamy URL.' }, { quoted: message });
      }
    }
  }
};
