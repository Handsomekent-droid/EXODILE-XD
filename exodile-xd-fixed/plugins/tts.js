...
module.exports = {
  ...
  async handler(sock, message, args, context = {}) {
    ...
    if (!text) {
      await sock.sendMessage(chatId, { text: '*ᴘʟᴇᴀsᴇ provide the text for TTS conversion.*' }, { quoted: message });
      return;
    }
    ...
    gtts.save(filePath, async function (err) {
      if (err) {
        await sock.sendMessage(chatId, { text: '❌ ᴇʀʀᴏʀ generating TTS audio.' }, { quoted: message });
        return;
      }
