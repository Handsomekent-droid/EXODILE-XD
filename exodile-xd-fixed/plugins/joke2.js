  ...
  async handler(sock, message, args, context = {}) {
    ...
    try {
      ...
      if (!res.data || res.data.status !== true) {
        return await sock.sendMessage(chatId, { text: '❌ ꜰᴀɪʟᴇᴅ to fetch joke.' }, { quoted: message });
      }
      ...
      await sock.sendMessage(chatId, { text: '❌ ᴇʀʀᴏʀ while fetching joke.' }, { quoted: message });
    }
  }
};
