...
module.exports = {
  command: 'watercolorai',
  aliases: ['watercolor', 'aiwater'],
  category: 'images',
  description: 'ɢᴇɴᴇʀᴀᴛᴇ ᴡᴀᴛᴇʀᴄᴏʟᴏʀ ᴀɪ ɪᴍᴀɢᴇ',
  usage: '.watercolorai <ᴘʀᴏᴍᴘᴛ>',
  ...
  async handler(sock, message, args, context = {}) {
    ...
    await sock.sendMessage(chatId, { text: `𖤐 ɢᴇɴᴇʀᴀᴛɪɴɢ *ᴡᴀᴛᴇʀᴄᴏʟᴏʀ* ɪᴍᴀɢᴇ...`, ...ci }, { quoted: message });
    try {
      const imgUrl = await fetchImageUrl(prompt, 'watercolor');
      ...
      if (imgUrl.startsWith('http')) {
        ...
        await sock.sendMessage(chatId, { image: Buffer.from(data), caption: H + `𖤐 *ᴡᴀᴛᴇʀᴄᴏʟᴏʀ*\n𖤐 ᴘʀᴏᴍᴘᴛ: ${prompt}`, ...ci }, { quoted: message });
      } else {
        await sock.sendMessage(chatId, { image: { url: imgUrl }, caption: H + `𖤐 *ᴡᴀᴛᴇʀᴄᴏʟᴏʀ*\n𖤐 ᴘʀᴏᴍᴘᴛ: ${prompt}`, ...ci }, { quoted: message });
      }
    } catch (e) {
