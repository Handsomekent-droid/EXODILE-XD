...
module.exports = {
  ...
  async handler(sock, message, args, context = {}) {
    ...
    if (!text) {
      return await sock.sendMessage(chatId, { text: 'ᴘʟᴇᴀsᴇ provide text after the .attp ᴄᴏᴍᴍᴀɴᴅ.' }, { quoted: message });
    }
    ...
    try {
      ...
      await sock.sendMessage(chatId, { text: '❌ ꜰᴀɪʟᴇᴅ to generate the sticker locally.' }, { quoted: message });
    }
  }
};
