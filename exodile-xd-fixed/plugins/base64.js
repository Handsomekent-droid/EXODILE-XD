module.exports = {
  ...
  async handler(sock, message, args, context = {}) {
    ...
    try {
      ...
      if (!txt) {
        return await sock.sendMessage(chatId, { text: '*ᴘʟᴇᴀsᴇ provide text to encode or reply to a message.*\nExample: .base64 Hello World' }, { quoted: message });
      }
      ...
      await sock.sendMessage(chatId, { text: '❌ ꜰᴀɪʟᴇᴅ to encode text.' }, { quoted: message });
    }
  }
};
