...
module.exports = {
  ...
  async handler(sock, message, args, context = {}) {
    ...
    if (!query) {
      await sock.sendMessage(chatId, { text: 'ᴘʟᴇᴀsᴇ provide a search term for the GIF.' }, { quoted: message });
      return;
    }
    try {
      ...
      console.error(error);
      await sock.sendMessage(chatId, { text: '❌ ꜰᴀɪʟᴇᴅ to fetch GIF. ᴘʟᴇᴀsᴇ try again later.' }, { quoted: message });
    }
  }
};
