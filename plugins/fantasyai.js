...
module.exports = {
  command: 'fantasyai',
  aliases: ['fantasy', 'aifantasy'],
  category: 'images',
  description: 'ɢᴇɴᴇʀᴀᴛᴇ ꜰᴀɴᴛᴀsʏ ᴀɪ ɪᴍᴀɢᴇ',
  usage: '.fantasyai <ᴘʀᴏᴍᴘᴛ>',
  ...
  async handler(sock, message, args, context = {}) {
    ...
    await sock.sendMessage(chatId, { text: `𖤐 ɢᴇɴᴇʀᴀᴛɪɴɢ *ꜰᴀɴᴛᴀsʏ* ɪᴍᴀɢᴇ...`, ...ci }, { quoted: message });
    try {
      const imgUrl = await fetchImageUrl(prompt, 'fantasy');
      ...
      if (imgUrl.startsWith('http')) {
        ...
        await sock.sendMessage(chatId, { image: Buffer.from(data), caption: H + `𖤐 *ꜰᴀɴᴛᴀsʏ*\n𖤐 ᴘʀᴏᴍᴘᴛ: ${prompt}`, ...ci }, { quoted: message });
      } else {
        await sock.sendMessage(chatId, { image: { url: imgUrl }, caption: H + `𖤐 *ꜰᴀɴᴛᴀsʏ*\n𖤐 ᴘʀᴏᴍᴘᴛ: ${prompt}`, ...ci }, { quoted: message });
      }
    } catch (e) {
