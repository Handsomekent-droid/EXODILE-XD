        ...
        if (totalMentions >= 3) {
            ...
            if (totalMentions >= mentionThreshold || hasManyNumericMentions) {
                ...
                if (action === 'delete') {
                    ...
                    await sock.sendMessage(chatId, {
                        text: `⚠️ *Tagall Detected!*\n\n@${senderId.split('@')[0]}, tagging all members is not allowed go tag your family.`,
                        mentions: [senderId]
                    });
                    ...
                    try {
                        ...
                        await sock.sendMessage(chatId, {
                            text: `🚫 *Antitag Action!*\n\n@${senderId.split('@')[0]} has been removed for tagging all members. What a stupid🤡 kid.`,
                            mentions: [senderId]
                        });
                    } catch (error) {
                        await sock.sendMessage(chatId, {
        ...
        switch (action) {
            ...
            case 'set':
                ...
                const actionDescriptions = {
                    ...
                    kick: 'Delete messages and remove users from ɢʀᴏᴜᴘ'
                };
                
                await sock.sendMessage(chatId, {
                    text: setResult 
                        ? `✅ *Antitag action set to: ${setAction}*\n\n${actionDescriptions[setAction]}`
                        : '❌ *ꜰᴀɪʟᴇᴅ to set antitag action*'
                }, { quoted: message });
                break;
            ...
            case 'get':
                ...
                await sock.sendMessage(chatId, {
                    text: `*🏷️ ANTITAG STATUS*\n\n` +
                          ...
                          `*Detection threshold:* 50% of ɢʀᴏᴜᴘ members or 10+ mentions`
                }, { quoted: message });
                break;
