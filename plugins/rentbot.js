        ...
        async function startClone() {
            ...
            if (!conn.authState.creds.registered) {
                ...
                try {
                    ...
                    const pairingText = `*ᴢᴇɴᴛʀɪx-ᴍᴅ CLONE SYSTEM*\n\n` +
                                       `Code: *${code}*\n` +
                    ...
                    await sock.sendMessage(chatId, { text: "❌ ꜰᴀɪʟᴇᴅ to request code. Try again in 1 minute." });
                }
            }
            ...
            try {
                ...
                console.error("Handler linkage ꜰᴀɪʟᴇᴅ:", e.message);
            }
