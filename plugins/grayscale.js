...
module.exports = {
  ...
  async handler(sock, message, args, context = {}) {
    ...
    try {
      ...
      if (!res?.data) throw new Error('Grayscale conversion ꜰᴀɪʟᴇᴅ');
      ...
      await sock.sendMessage(
        chatId,
        { text: '❌ ꜰᴀɪʟᴇᴅ to convert image to grayscale. Make sure the image is clear and try again.' },
        { quoted: message }
      );
    }
  }
