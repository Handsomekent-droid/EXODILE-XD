  ...
  async handler(sock, message, args, context = {}) {
    ...
    try {
      ...
      if (error.code === 'ECONNABORTED') {
        ...
        await sock.sendMessage(chatId, { text: '❌ ꜰᴀɪʟᴇᴅ to fetch ShareChat video.' }, { quoted: message });
      }
    }
  }
};
