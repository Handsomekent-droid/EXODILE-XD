...
module.exports = {
  ...
  async handler(sock, message, args, context = {}) {
    ...
    if (!url) {
      return await sock.sendMessage(chatId, { text: 'ᴘʟᴇᴀsᴇ provide an iStock URL.\nExample: .istock https://www.istockphoto.com/video/...' }, { quoted: message });
    }
    ...
    try {
      ...
      if (!data?.status || !data.result) {
        return await sock.sendMessage(chatId, { text: '❌ ꜰᴀɪʟᴇᴅ to fetch media from the provided iStock URL.' }, { quoted: message });
      }
      ...
      if (error.code === 'ECONNABORTED') {
        ...
        await sock.sendMessage(chatId, { text: '❌ ꜰᴀɪʟᴇᴅ to download media from iStock URL.' }, { quoted: message });
      }
    }
  }
};
