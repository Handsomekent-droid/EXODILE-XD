...
module.exports = {
  ...
  async handler(sock, message, args, context = {}) {
    ...
    try {
      if (!query) return await sock.sendMessage(chatId, { text: '*ᴘʟᴇᴀsᴇ provide an app name.*\nExample: .playstore Instagram' }, { quoted: message });
      ...
      const timeout = setTimeout(async () => {
        ...
        await sock.sendMessage(chatId, { text: '⌛ Selection expired. ᴘʟᴇᴀsᴇ search again.' }, { quoted: sentMsg });
      }, 5 * 60 * 1000);
      ...
      const listener = async ({ messages }) => {
        ...
        if (!app)
          return await sock.sendMessage(chatId, { text: '❌ ꜰᴀɪʟᴇᴅ to fetch app details.' }, { quoted: m });
      ...
      await sock.sendMessage(chatId, { text: '❌ ꜰᴀɪʟᴇᴅ to process request.' }, { quoted: message });
    }
  }
};
