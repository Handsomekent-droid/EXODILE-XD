module.exports = {
  ...
  async handler(sock, message, args, context = {}) {
    ...
    try {
      ...
      if (!text) {
        return await sock.sendMessage(chatId, { text: '*ᴘʟᴇᴀsᴇ provide text or reply to a message to obfuscate!*' }, { quoted: message });
      }
      ...
      await sock.sendMessage(chatId, { text: '❌ ᴇʀʀᴏʀ generating code.' }, { quoted: message });
    }
  }
};
