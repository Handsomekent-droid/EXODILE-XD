...
module.exports = {
  command: 'oilpaintingai',
  aliases: ['oilpainting', 'aioil'],
  category: 'images',
  description: 'ɢᴇɴᴇʀᴀᴛᴇ ᴏɪʟ ᴘᴀɪɴᴛɪɴɢ ᴀɪ ɪᴍᴀɢᴇ',
  usage: '.oilpaintingai <ᴘʀᴏᴍᴘᴛ>',
  ...
  async handler(sock, message, args, context = {}) {
    ...
    await sock.sendMessage(chatId, { text: `𖤐 ɢᴇɴᴇʀᴀᴛɪɴɢ *ᴏɪʟ ᴘᴀɪɴᴛɪɴɢ* ɪᴍᴀɢᴇ...`, ...ci }, { quoted: message });
    try {
      const imgUrl = await fetchImageUrl(prompt, 'oilpainting');
      ...
      if (imgUrl.startsWith('http')) {
        ...
        await sock.sendMessage(chatId, { image: Buffer.from(data), caption: H + `𖤐 *ᴏɪʟ ᴘᴀɪɴᴛɪɴɢ*\n𖤐 ᴘʀᴏᴍᴘᴛ: ${prompt}`, ...ci }, { quoted: message });
      } else {
        await sock.sendMessage(chatId, { image: { url: imgUrl }, caption: H + `𖤐 *ᴏɪʟ ᴘᴀɪɴᴛɪɴɢ*\n𖤐 ᴘʀᴏᴍᴘᴛ: ${prompt}`, ...ci }, { quoted: message });
      }
    } catch (e) {
